...
RUN php -d date.timezone=UTC ./opt/bitnami/prestashop/vendor/bin/phpunit -c /opt/bitnami/prestashop/tests/Unit/phpunit.xml --log-junit /opt/bitnami/prestashop/results.xml    
